...
1. Select the chain and then the pool you want to remove liquidity from.  In our example, we will remove liquidity from the pool ZERO-AVAX on the Avalanche chain  
